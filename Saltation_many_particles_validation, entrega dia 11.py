...
def particula(z,t):
	...
	for i in range(Nparticulas):
		...
		x = linspace(0, 20*d,4000)       # todo esto es sobre el relieve del suelo
		x_mod_d = (x % d) - d/2			 # hay que corregirlo, en esta pocision no 
		y = sqrt((d/2)**2 - x_mod_d**2)  # esta haciendo nada
